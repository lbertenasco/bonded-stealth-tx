...
contract StealthVault is UtilsReady, IStealthVault {
    ...
    function _takeBond(address _caller, uint256 _amount, address _reportedBy) internal {
        bonded[_caller] = bonded[_caller] - _amount;
    ...
    // Hash
    function validateHash(address _caller, bytes32 _hash, uint256 _penalty) external override returns (bool) {
